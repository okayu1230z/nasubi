...
# $ python mk_snsrdt_yr.py [ディレクトリ] [年] [１つあたりのデータ量]
...
# ディレクトリtestの中に2018というディレクトリを作り，
# その中に， 1K * 1000 * 365 = 365000KB = 356.445MB = 0.348GB のセンサデータを生成する．

# （例） $ python mk_snsrdt_yr.py test 2018 100K
# 100K * 1000 * 365 = 36500000KB = 35644.5MB = 34.8GB
# 四年分作る ~~ * 4 = 139.2GB
